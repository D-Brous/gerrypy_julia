...
PLACES_PATH_2020 = os.path.join(GERRYPY_BASE_PATH, 'data', 'data2020', 'places')
PRECINCT_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'precincts')
PRECINCT_PATH_2020 = os.path.join(GERRYPY_BASE_PATH, 'data', 'data2020', 'precincts')
OPT_DATA_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'optimization_data')
OPT_DATA_PATH_2020 = os.path.join(GERRYPY_BASE_PATH, 'data', 'data2020', 'optimization_data')
CENSUS_SHAPE_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'shapes')
CENSUS_SHAPE_PATH_2020 = os.path.join(GERRYPY_BASE_PATH, 'data', 'data2020', 'raw_shapefiles')
BLOCK_DATA_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'acs_data', 'block')
BLOCK_GROUP_DATA_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'acs_data', 'block_group')
TRACT_DATA_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'acs_data', 'tract')
TRACT_DATA_PATH_2020 = os.path.join(GERRYPY_BASE_PATH, 'data', 'data2020', 'acs_tract_data')
COUNTY_DATA_PATH = os.path.join(GERRYPY_BASE_PATH, 'data', 'acs_data', 'county')
...
RESULTS_PATH = os.path.join(GERRYPY_BASE_PATH, 'results', 'al')
LOUISIANA_HOUSE_RESULTS_PATH = os.path.join(GERRYPY_BASE_PATH, 'results', 'la_house')
BUFFALO_RESULTS_PATH = os.path.join(GERRYPY_BASE_PATH, 'results', 'buffalo')
...
OPT_DATA_PATH_BUFFALO = os.path.join(GERRYPY_BASE_PATH, 'data', 'buffalo_data', 'optimization_data')
CENSUS_SHAPE_PATH_BUFFALO = os.path.join(GERRYPY_BASE_PATH, 'data', 'buffalo_data', 'raw_shapefiles')
