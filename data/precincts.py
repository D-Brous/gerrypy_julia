...
class StatePrecinctWrapper:
    ...
    def get_data(self, target_geometry=None, county_inference=True):
        """
        ...
        tract_coverages = [self.compute_tract_coverage(precincts, target_geometry)
        ...
        if self.county_inference is None or not county_inference:
            return tract_votes
    ...
    def compute_tract_coverage(self, precincts, target_geometry=None):
        """
